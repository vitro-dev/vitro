...
def test_parse_vitro_config_valid_inventory_env_configs() -> None:
    """Check parsing succeeds with valid inventory and env configs."""
    bf_config = parse_vitro_config(
...
def test_parse_vitro_config_env_inventory_requirement_missmatch() -> None:
...
def test_parse_vitro_config_no_sufficient_lan_clients() -> None:
...
def test_parse_vitro_config_no_lan_clients() -> None:
...
def test_parse_vitro_config_wifi_clients_available() -> None:
...
def test_parse_vitro_config_requested_wifi_clients_not_available() -> None:
...
def test_parse_vitro_config_wifi_device_not_found_for_band_env_wifi_client() -> None:
...
def test_parse_vitro_config_wan_clients_available() -> None:
