...
from vitro.libraries.utils import get_value_from_dict


class VitroConfig:
    """Vitro environment config."""
...
def parse_vitro_config(
    ...
    return VitroConfig(merged_devices_config, env_json_config, inventory_config)
