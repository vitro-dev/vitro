...
class DockerComposeGenerator:
    ...
    def __init__(self, vitro_config: VitroConfig) -> None:
        """Initialize the YMLManager for Docker Factory v2.

        :param vitro_config: Vitro Config instance
        :type vitro_config: VitroConfig
        """
        self._templates_path = Path(__file__).parent / "templates"
        self._vitro_config = vitro_config
        self._devices_list: list[str] = []
        self._get_devices(self._vitro_config.env_config)
    ...
    def _get_requested_device_count(self, device_name: str) -> int:
        ...
        return recursive_count(self._vitro_config.env_config)
    ...
    def _get_devices(self, env_config: dict[str, Any]) -> None:
        ...
        :param env_config: Vitro environment config
