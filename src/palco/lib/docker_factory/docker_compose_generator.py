...
class DockerComposeGenerator:
    ...
    def __init__(self, palco_config: PalcoConfig) -> None:
        """Initialize the YMLManager for Docker Factory v2.

        :param palco_config: Palco Config instance
        :type palco_config: PalcoConfig
        """
        self._templates_path = Path(__file__).parent / "templates"
        self._palco_config = palco_config
        self._devices_list: list[str] = []
        self._get_devices(self._palco_config.env_config)
    ...
    def _get_requested_device_count(self, device_name: str) -> int:
        ...
        return recursive_count(self._palco_config.env_config)
    ...
    def _get_devices(self, env_config: dict[str, Any]) -> None:
        ...
        :param env_config: Palco environment config
