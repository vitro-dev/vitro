...
from vitro.exceptions import DeviceConnectionError, VitroError
...
class SSHConnection(VitroPexpect):
    ...
    def check_output(self, cmd: str, timeout: int = 30) -> str:
        ...
        :raises VitroException: if command doesn't execute in specified timeout
